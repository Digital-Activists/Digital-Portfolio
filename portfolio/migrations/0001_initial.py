# Generated by Django 5.0.4 on 2024-05-10 10:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Полная занятость', 'Полная занятость'), ('Частичная занятость', 'Частичная занятость'), ('Проектная работа', 'Проектная работа'), ('Стажировка', 'Стажировка'), ('Волонтерство', 'Волонтерство')], max_length=30)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Грамотная речь', 'Грамотная речь'), ('Управление персоналом', 'Управление персоналом'), ('Деловое общение', 'Деловое общение'), ('Управление проектами', 'Управление проектами'), ('Работа с большим объемом информации', 'Работа с большим объемом информации'), ('Креативность', 'Креативность'), ('Подбор персонала', 'Подбор персонала'), ('Ориентация на результат', 'Ориентация на результат'), ('Управленческие навыки', 'Управленческие навыки'), ('Мотивация персонала', 'Мотивация персонала'), ('Руководство коллективом', 'Руководство коллективом')], max_length=50)),
            ],
            bases=(portfolio.models.StrMixin, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Полный день', 'Полный день'), ('Сменный график', 'Сменный график'), ('Гибкий график', 'Гибкий график'), ('Удаленная работа', 'Удаленная работа'), ('Вахтовый метод', 'Вахтовый метод')], max_length=30)),
            ],
            bases=(portfolio.models.StrMixin, models.Model),
        ),
        migrations.CreateModel(

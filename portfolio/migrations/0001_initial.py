    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rhythm', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='posts', to='portfolio.postrhythm', verbose_name='Ритм')),
            ],
            options={
                'ordering': ['-created_at'],
            },
